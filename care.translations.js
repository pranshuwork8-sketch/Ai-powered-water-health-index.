(function (global) {
  const careStrings = {
    ...
    en: {
      ...
      care_intro: "Understand your latest reading, follow a clear care plan for your water, and see simple ways to guard wells, tanks, ponds and shared water bodies.",

      last_title: "1. My latest reading",
      last_load_btn: "Load latest from history",
      last_clear_checks: "Clear care checklist",
      last_empty_note: "Load the latest reading from the Measure page to see a care plan created from its index and pH.",
      ...
      reminder_ok: "You tested {n} days ago. Keep checking and test again when the reminder is due.",
      ...
      care_footer_note: "Use this care plan together with the Map and Farmers assistant pages to choose next steps for your family, farm or community.",
    ...
    hi: {
      ...
      care_intro: "अपनी ताज़ा रीडिंग को समझें, पानी के लिए साफ‑साधा देखभाल प्लान पाएं और कुओं, टैंकों, तालाबों व सामुदायिक जल स्रोतों की सुरक्षा के आसान तरीके जानें।",

      last_title: "1. मेरी ताज़ा रीडिंग",
      last_load_btn: "इतिहास से ताज़ा रीडिंग लोड करें",
      last_clear_checks: "देखभाल चेकलिस्ट साफ करें",
      last_empty_note: "इंडेक्स और pH के आधार पर देखभाल योजना देखने के लिए माप (Measure) पेज से ताज़ा रीडिंग लोड करें।",
      ...
      reminder_due: "रिमाइंडर: {n} दिन हो चुके हैं, कृपया अपना पानी फिर से जाँच लें।",
      reminder_ok: "आपने {n} दिन पहले पानी की जाँच की थी। ध्यान रखते रहें और समय आने पर दोबारा जाँच करें।",
      ...
      care_footer_note: "अपने परिवार, खेत या बस्ती के अगले कदम तय करने के लिए इस देखभाल योजना को मानचित्र और किसान सहायता पेज के साथ मिलाकर उपयोग करें।",
    ...
    bn: {
      ...
      care_intro: "আপনার সর্বশেষ রিডিং কী বলছে তা বুঝুন, পানির জন্য সহজ যত্ন পরিকল্পনা নিন এবং কুয়ো, ট্যাংক, পুকুর ও কমিউনিটি জলস্রোতকে রক্ষা করার সহজ উপায় শিখুন।",

      last_title: "১. আমার সর্বশেষ রিডিং",
      last_load_btn: "ইতিহাস থেকে সর্বশেষ নিন",
      last_clear_checks: "যত্ন চেকলিস্ট মুছে ফেলুন",
      last_empty_note: "ইন্ডেক্স ও pH‑এর উপর ভিত্তি করে যত্ন পরিকল্পনা দেখতে Measure পেজ থেকে সর্বশেষ রিডিং লোড করুন।",
      ...
      reminder_ok: "আপনি {n} দিন আগে পরীক্ষা করেছেন। নজর রাখুন এবং সময় হলে আবার পরীক্ষা করুন।",
      ...
      care_footer_note: "আপনার পরিবার, খেত বা কমিউনিটির পরবর্তী পদক্ষেপ ঠিক করতে এই যত্ন পরিকল্পনাকে মানচিত্র ও কৃষক সহায়তা পেজের সঙ্গে একসাথে ব্যবহার করুন।",
...
function getCareStrings(langCode) {
    ...
    const lang = careStrings[langCode] || base;
    
    // Merge top-level keys
    const merged = Object.assign({}, base, lang);
    
    // Explicitly merge nested objects so missing translations fall back to English
    ...
    merged.communityCareList = lang.communityCareList || base.communityCareList;
